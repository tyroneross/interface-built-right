...
var DesignSystemViolationSchema = zod.z.object({
...
var DesignSystemResultSchema = zod.z.object({
  configName: zod.z.string(),
  principleViolations: zod.z.array(DesignSystemViolationSchema),
  ...
  customViolations: zod.z.array(DesignSystemViolationSchema),
...
var CalmPrecisionConfigSchema = zod.z.object({
...
var TypographyTokensSchema = zod.z.object({
...
var DesignSystemConfigSchema = zod.z.object({
  version: zod.z.literal(1),
  name: zod.z.string(),
...
exports.ANDROID_CHROME_UA = ANDROID_CHROME_UA;
...
exports.DesignSystemResultSchema = DesignSystemResultSchema;
exports.DesignSystemViolationSchema = DesignSystemViolationSchema;
...
exports.TABLET_SAFARI_UA = TABLET_SAFARI_UA;
