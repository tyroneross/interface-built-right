...
var init_schemas = __esm({
  "src/schemas.ts"() {
    exports.ViewportSchema = zod.z.object({
      ...
      height: zod.z.number().min(100).max(2160),
      deviceScaleFactor: zod.z.number().min(0.5).max(5).optional(),
      mobile: zod.z.boolean().optional(),
      userAgent: zod.z.string().optional(),
      hasTouch: zod.z.boolean().optional()
    });
    exports.VIEWPORTS = {
    ...
    exports.ThresholdBasisSchema = zod.z.enum(["research", "internal-testing", "hypothesis"]);
    exports.ProvenancedThresholdSchema = zod.z.object({
      value: zod.z.number(),
      basis: exports.ThresholdBasisSchema,
      rationale: zod.z.string().min(1),
      source: zod.z.string().optional(),
      reviewedAt: zod.z.string()
    });
    exports.VerdictPolicySchema = zod.z.object({
      /** Regions with changed-pixel share at or below this are not reported (noise floor). */
      regionReportFloorPercent: exports.ProvenancedThresholdSchema,
      /** Region change above this → 'critical' severity (drives LAYOUT_BROKEN). */
      regionCriticalPercent: exports.ProvenancedThresholdSchema,
      /** Region change above this (and ≤ critical) → 'unexpected' severity. */
      regionUnexpectedPercent: exports.ProvenancedThresholdSchema,
      /** Overall diff above this → UNEXPECTED_CHANGE even with no unexpected region. */
      unexpectedOverallPercent: exports.ProvenancedThresholdSchema,
      /** Overall diff above this → fallback region location 'full' (else 'center'); presentation only. */
      fullFrameFallbackPercent: exports.ProvenancedThresholdSchema,
      /** Verdict tolerance: overall diff at/below this stays EXPECTED and is never escalated to unexpected. */
      allowedDiffPercent: exports.ProvenancedThresholdSchema
    });
    exports.ThresholdOverrideSchema = zod.z.union([
      zod.z.number(),
      exports.ProvenancedThresholdSchema.partial()
    ]);
    exports.VerdictPolicyOverrideSchema = zod.z.object({
      regionReportFloorPercent: exports.ThresholdOverrideSchema.optional(),
      regionCriticalPercent: exports.ThresholdOverrideSchema.optional(),
      regionUnexpectedPercent: exports.ThresholdOverrideSchema.optional(),
      unexpectedOverallPercent: exports.ThresholdOverrideSchema.optional(),
      fullFrameFallbackPercent: exports.ThresholdOverrideSchema.optional(),
      allowedDiffPercent: exports.ThresholdOverrideSchema.optional()
    });
    exports.ConfigSchema = zod.z.object({
      /**
       ...
       * the fix.
       */
      baseUrl: zod.z.string().url("Must be a valid URL").optional(),
      outputDir: zod.z.string().default("./.ibr"),
      viewport: exports.ViewportSchema.default(exports.VIEWPORTS.desktop),
      viewports: zod.z.array(exports.ViewportSchema).optional(),
      // Multi-viewport support
      /** Verdict tolerance: overall diff percent (0-100) treated as an acceptable change. */
      allowedDiffPercent: zod.z.number().min(0).max(100).optional(),
      /**
       ...
       */
      verdictPolicy: exports.VerdictPolicyOverrideSchema.optional(),
      /** Pixelmatch per-pixel color sensitivity (0-1, lower = stricter). Default 0.1. */
      pixelColorThreshold: zod.z.number().min(0).max(1).default(0.1),
    ...
    exports.SessionQuerySchema = zod.z.object({
    ...
    exports.ComparisonResultSchema = zod.z.object({
      match: zod.z.boolean(),
      ...
      pixelColorThreshold: zod.z.number().optional()
    });
    exports.ChangedRegionSchema = zod.z.object({
       ...
       */
      diffPercent: zod.z.number().optional()
    });
    exports.VerdictSchema = zod.z.enum([
      "MATCH",
      "EXPECTED_CHANGE",
      "UNEXPECTED_CHANGE",
      "LAYOUT_BROKEN"
    ]);
    exports.AnalysisSchema = zod.z.object({
      verdict: exports.VerdictSchema,
      summary: zod.z.string(),
      changedRegions: zod.z.array(exports.ChangedRegionSchema),
      unexpectedChanges: zod.z.array(exports.ChangedRegionSchema),
       ...
       */
      policy: exports.VerdictPolicySchema.optional()
    });
    exports.SessionStatusSchema = zod.z.enum(["baseline", "compared", "pending"]);
    exports.BoundsSchema = zod.z.object({
      x: zod.z.number(),
      y: zod.z.number(),
      width: zod.z.number(),
      height: zod.z.number()
    });
    exports.LandmarkElementSchema = zod.z.object({
      name: zod.z.string(),
      // e.g., 'logo', 'header', 'nav'
    ...
    exports.InteractiveStateSchema = zod.z.object({
      ...
      isContentEditable: zod.z.boolean().optional(),
      ...
      hasNativeActivation: zod.z.boolean().optional()
    });
    exports.A11yAttributesSchema = zod.z.object({
    ...
    exports.TargetContextSchema = zod.z.object({
       ...
       * has one or two.
       */
      surroundingTextChars: zod.z.number().optional(),
      /**
       ...
       */
      labelTargetBounds: exports.BoundsSchema.optional(),
      /**
       ...
       */
      associatedLabels: zod.z.number().optional()
    });
    exports.EnhancedElementSchema = zod.z.object({
      // Identity
      selector: zod.z.string(),
      ...
      href: zod.z.string().nullable().optional(),
      // Position
       ...
       */
      ancestorOpacity: zod.z.number().optional(),
      // Interactivity
    ...
    exports.ElementIssueSchema = zod.z.object({
      type: zod.z.enum([
        "NO_HANDLER",
    ...
    exports.AuditResultSchema = zod.z.object({
      totalElements: zod.z.number(),
      interactiveCount: zod.z.number(),
      withHandlers: zod.z.number(),
      withoutHandlers: zod.z.number(),
      issues: zod.z.array(exports.ElementIssueSchema)
    });
    exports.RuleSeveritySchema = zod.z.enum(["off", "warn", "error"]);
    exports.RuleSettingSchema = zod.z.union([
      exports.RuleSeveritySchema,
      zod.z.tuple([exports.RuleSeveritySchema, zod.z.record(zod.z.string(), zod.z.unknown())])
    ]);
    exports.RulesConfigSchema = zod.z.object({
      extends: zod.z.array(zod.z.string()).optional(),
      rules: zod.z.record(zod.z.string(), exports.RuleSettingSchema).optional()
    });
    exports.ViolationSchema = zod.z.object({
      ruleId: zod.z.string(),
    ...
    exports.RuleAuditResultSchema = zod.z.object({
      url: zod.z.string(),
      timestamp: zod.z.string(),
      elementsScanned: zod.z.number(),
      violations: zod.z.array(exports.ViolationSchema),
    ...
    exports.MemorySourceSchema = zod.z.enum(["user", "learned", "framework"]);
    exports.PreferenceCategorySchema = zod.z.enum([
      "color",
      "layout",
      "typography",
      "navigation",
    ...
    exports.ExpectationOperatorSchema = zod.z.enum(["equals", "contains", "matches", "gte", "lte"]);
    exports.ExpectationSchema = zod.z.object({
      property: zod.z.string(),
      operator: exports.ExpectationOperatorSchema,
      value: zod.z.string()
    });
    exports.PreferenceSchema = zod.z.object({
      id: zod.z.string(),
      description: zod.z.string(),
      category: exports.PreferenceCategorySchema,
      source: exports.MemorySourceSchema,
      route: zod.z.string().optional(),
      componentType: zod.z.string().optional(),
      expectation: exports.ExpectationSchema,
      confidence: zod.z.number().min(0).max(1).default(1),
      createdAt: zod.z.string().datetime(),
      updatedAt: zod.z.string().datetime(),
      sessionIds: zod.z.array(zod.z.string()).optional()
    });
    exports.ObservationSchema = zod.z.object({
      description: zod.z.string(),
      category: exports.PreferenceCategorySchema,
      property: zod.z.string(),
      value: zod.z.string()
    });
    exports.LearnedExpectationSchema = zod.z.object({
      id: zod.z.string(),
      sessionId: zod.z.string(),
      route: zod.z.string(),
      observations: zod.z.array(exports.ObservationSchema),
      approved: zod.z.boolean(),
      createdAt: zod.z.string().datetime()
    });
    exports.ActivePreferenceSchema = zod.z.object({
      id: zod.z.string(),
      description: zod.z.string(),
      category: exports.PreferenceCategorySchema,
      route: zod.z.string().optional(),
    ...
    exports.MemorySummarySchema = zod.z.object({
      ...
      activePreferences: zod.z.array(exports.ActivePreferenceSchema)
    });
    exports.DesignSystemViolationSchema = zod.z.object({
      principleId: zod.z.string(),
      principleName: zod.z.string(),
      severity: zod.z.enum(["error", "warn"]),
      message: zod.z.string(),
      element: zod.z.string().optional(),
      bounds: exports.BoundsSchema.optional(),
      fix: zod.z.string().optional()
    });
    exports.DesignSystemResultSchema = zod.z.object({
      configName: zod.z.string(),
      principleViolations: zod.z.array(exports.DesignSystemViolationSchema),
      tokenViolations: zod.z.array(zod.z.object({
        element: zod.z.string(),
        property: zod.z.string(),
        expected: zod.z.union([zod.z.string(), zod.z.number()]),
        actual: zod.z.union([zod.z.string(), zod.z.number()]),
        severity: zod.z.enum(["error", "warning"]),
        message: zod.z.string()
      })),
      customViolations: zod.z.array(exports.DesignSystemViolationSchema),
      /**
       ...
       */
      complianceScore: zod.z.number().min(0).max(100).nullable(),
      ...
      coverage: zod.z.object({
        ...
        elementsConsidered: zod.z.number(),
        elementsEvaluated: zod.z.number(),
        elementsSkippedNoStyles: zod.z.number(),
        declaredCategories: zod.z.array(zod.z.string()),
        validatedCategoriesDeclared: zod.z.array(zod.z.string()),
        categoriesWithoutValidator: zod.z.array(zod.z.string())
      }).optional()
    });
  }
});
...
function resolveDevice(name) {
  const profile = exports.DEVICES[name];
  if (!profile) {
    const known = exports.DEVICE_NAMES.join(", ");
    throw new Error(
...
exports.MOBILE_SAFARI_UA = void 0; exports.TABLET_SAFARI_UA = void 0; exports.ANDROID_CHROME_UA = void 0; exports.DEVICES = void 0; exports.DEVICE_NAMES = void 0;
var init_devices = __esm({
  "src/devices.ts"() {
    exports.MOBILE_SAFARI_UA = "Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1";
    exports.TABLET_SAFARI_UA = "Mozilla/5.0 (iPad; CPU OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1";
    exports.ANDROID_CHROME_UA = "Mozilla/5.0 (Linux; Android 14; Pixel 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Mobile Safari/537.36";
    exports.DEVICES = {
      "iphone-14": {
        name: "iphone-14",
        width: 390,
        ...
        deviceScaleFactor: 3,
        mobile: true,
        userAgent: exports.MOBILE_SAFARI_UA,
        hasTouch: true
      },
      "iphone-14-pro-max": {
      ...
      "pixel-7": {
        ...
        mobile: true,
        userAgent: exports.ANDROID_CHROME_UA,
        hasTouch: true
      },
      "ipad-air": {
        name: "ipad-air",
        ...
        deviceScaleFactor: 2,
        mobile: true,
        userAgent: exports.TABLET_SAFARI_UA,
        hasTouch: true
      },
      "ipad-pro-11": {
        name: "ipad-pro-11",
    ...
    exports.DEVICE_NAMES = Object.freeze(
      Object.keys(exports.DEVICES)
    );
  }
});
...
function reclaimStaleSingletonLock(lockPath, profileDir) {
  let target;
  try {
    target = fs$1.readlinkSync(lockPath);
  } catch {
    return false;
  }
  ...
  let lockAgeMs;
  try {
    lockAgeMs = Date.now() - fs$1.lstatSync(lockPath).mtimeMs;
  } catch {
    return false;
  }
...
function reapOrphanedProfiles() {
  ...
  let entries;
  try {
    entries = fs$1.readdirSync(dir).filter((n) => n.startsWith("ibr-chrome-"));
  } catch {
    return;
  }
  const now = Date.now();
  for (const name of entries) {
    ...
    try {
      if (now - fs$1.statSync(full).mtimeMs < PROFILE_REAP_GRACE_MS) continue;
...
${tail}` : "";
      ...
      async close() {
        ...
        if (this._ephemeralProfileDir) {
          try {
            fs$1.rmSync(this._ephemeralProfileDir, { recursive: true, force: true });
          } catch {
          }
    ...
    AccessibilityDomain = class {
      ...
      convertToElements(nodes, clearMap = true) {
        ...
        for (const node of nodes) {
          ...
          let role = normalizeRole(node.role.value);
...
var AUTO_RESOLVE_MIN_SCORE, AUTO_RESOLVE_MIN_MARGIN, AUTO_RESOLVE_DESTRUCTIVE_MIN_SCORE, DESTRUCTIVE_LABEL_PATTERN, JARO_ACCEPT_MIN, ACTIONABILITY_PROBE_FN, FRAME_SKIP_ROLES, EngineDriver;
    ...
    EngineDriver = class _EngineDriver {
      ...
      convertFrameAXNodes(nodes, sessionId, frameTag) {
        ...
        for (const node of nodes) {
          ...
          let role = normalizeRole(roleValue);
          const label = node.name?.value ?? "";
...
async function waitForSelectorActionable(driver2, selector, options) {
  await waitForActionable(async () => {
    try {
      const state = await driver2.runtimeDomain.callFunctionOn(
...
var SELECTOR_ACTIONABILITY_PROBE_FN, CompatElementHandle, CompatLocator, ESBUILD_NAME_HELPER, CompatPage;
...
async function detectLandmarks(page) {
  const landmarks = [];
  for (const [name, selector] of Object.entries(exports.LANDMARK_SELECTORS)) {
    try {
...
exports.LANDMARK_SELECTORS = void 0;
var init_landmarks = __esm({
  "src/semantic/landmarks.ts"() {
    exports.LANDMARK_SELECTORS = {
  ...
  for (const node of nodes) {
    ...
    for (const axis of ["horizontal", "vertical"]) {
      ...
      while (cur && guard++ < 64) {
        ...
        const clamp2 = (cur.lineClamp ?? "").trim();
        if (clamp2 && clamp2 !== "none") sawEllipsisOrClamp = true;
...
var CustomCheckSchema, CustomPrincipleSchema, DEFAULT_CALM_PRECISION_CONFIG, CalmPrecisionConfigSchema, TypographyTokensSchema, DesignSystemConfigSchema;
var init_config = __esm({
  "src/design-system/config.ts"() {
    CustomCheckSchema = zod.z.object({
      property: zod.z.string(),
      operator: zod.z.enum(["equals", "in-set", "not-in-set", "gte", "lte", "contains"]),
      values: zod.z.array(zod.z.union([zod.z.string(), zod.z.number()]))
    });
    CustomPrincipleSchema = zod.z.object({
      id: zod.z.string(),
      name: zod.z.string(),
      description: zod.z.string(),
      category: zod.z.string(),
      severity: zod.z.enum(["error", "warn", "off"]),
      checks: zod.z.array(CustomCheckSchema)
    });
    ...
    CalmPrecisionConfigSchema = zod.z.object({
      core: zod.z.array(zod.z.string()).default(DEFAULT_CALM_PRECISION_CONFIG.core),
      stylistic: zod.z.array(zod.z.string()).default(DEFAULT_CALM_PRECISION_CONFIG.stylistic),
      severity: zod.z.record(zod.z.string(), zod.z.enum(["error", "warn", "off"])).default({})
    });
    TypographyTokensSchema = zod.z.object({
      fontFamilies: zod.z.record(zod.z.string(), zod.z.string()).optional(),
      fontSizes: zod.z.record(zod.z.string(), zod.z.number()).optional(),
      fontWeights: zod.z.record(zod.z.string(), zod.z.number()).optional(),
      lineHeights: zod.z.record(zod.z.string(), zod.z.number()).optional()
    });
    DesignSystemConfigSchema = zod.z.object({
      version: zod.z.literal(1),
      name: zod.z.string(),
      principles: zod.z.object({
        calmPrecision: CalmPrecisionConfigSchema.default(DEFAULT_CALM_PRECISION_CONFIG),
        custom: zod.z.array(CustomPrincipleSchema).default([])
      }).default({
        calmPrecision: DEFAULT_CALM_PRECISION_CONFIG,
        custom: []
      }),
      tokens: zod.z.object({
        colors: zod.z.record(zod.z.string(), zod.z.string()).optional(),
        typography: TypographyTokensSchema.optional(),
        spacing: zod.z.array(zod.z.number()).optional(),
        borderRadius: zod.z.record(zod.z.string(), zod.z.number()).optional(),
        shadows: zod.z.record(zod.z.string(), zod.z.string()).optional(),
        transitions: zod.z.record(zod.z.string(), zod.z.string()).optional(),
        touchTargets: zod.z.object({ min: zod.z.number() }).optional()
      }).default({})
    });
  }
});
...
function loadTokenSpec(specPath) {
  ...
  let spec;
  try {
    const content = fs$1.readFileSync(specPath, "utf-8");
...
var touchTargetValidator, fontSizeValidator, colorValidator, cornerRadiusValidator, spacingValidator, tokenValidators;
...
var STATE_RE;
var init_interaction_states = __esm({
  "src/sensors/interaction-states.ts"() {
    STATE_RE = /:(focus-visible|focus-within|hover|focus|active|disabled)\b/g;
  }
});
...
async function extractCssRulesAndMeta(page) {
  return page.evaluate((styleKeys) => {
    ...
    const STRUCTURAL_SELECTORS = [
      ...
      "span",
      "li"
      // typography: text-bearing content
    ];
...
async function initScanViewport(driver2, ownDriver, viewport) {
  if (ownDriver) return;
  await driver2.emulationDomain.applyDeviceProfile({
    width: viewport.width,
    height: viewport.height,
    deviceScaleFactor: viewport.deviceScaleFactor,
    mobile: viewport.mobile,
...
async function scan(url, options = {}) {
  ...
  try {
    ...
    await initScanViewport(driver2, ownDriver, resolvedViewport);
    await page.goto(url, {
      waitUntil: "domcontentloaded",
      timeout
    });
...
function getDeviceViewport(device) {
  for (const [pattern, key] of DEVICE_NAME_PATTERNS) {
    if (pattern.test(device.name)) {
      return exports.NATIVE_VIEWPORTS[key];
    }
  }
  if (device.platform === "watchos") {
    return exports.NATIVE_VIEWPORTS["watch-series-10-42mm"];
  }
  return exports.NATIVE_VIEWPORTS["iphone-16-pro"];
}
exports.NATIVE_VIEWPORTS = void 0; var DEVICE_NAME_PATTERNS;
var init_viewports = __esm({
  "src/native/viewports.ts"() {
    exports.NATIVE_VIEWPORTS = {
      // iPhone 16 series
      "iphone-16": { name: "iphone-16", width: 393, height: 852 },
      "iphone-16-plus": { name: "iphone-16-plus", width: 430, height: 932 },
      "iphone-16-pro": { name: "iphone-16-pro", width: 402, height: 874 },
...
function resolveSwiftSourceDir(runtimeModuleDir = moduleDir) {
  const candidates = [
    ...
    path.join(runtimeModuleDir, "swift", "ibr-ax-extract"),
    // Bundled package execution: dist/index.{js,mjs}
    path.join(runtimeModuleDir, "..", "src", "native", "swift", "ibr-ax-extract"),
...
async function ensureExtractor() {
  ...
  if (!fs$1.existsSync(SWIFT_PACKAGE_PATH)) {
    throw new Error(
  ...
  try {
    if (!fs$1.existsSync(SWIFT_BUILD_PATH) || !isFileFresh(SWIFT_BUILD_PATH)) {
      await buildSwiftExtractor();
    }
    if (!fs$1.existsSync(SWIFT_BUILD_PATH)) {
      throw new Error("Swift build succeeded but binary not found at expected path");
    }
    await fs.copyFile(SWIFT_BUILD_PATH, EXTRACTOR_PATH);
    await fs.chmod(EXTRACTOR_PATH, 493);
    return EXTRACTOR_PATH;
  } catch (err) {
    throw new Error(
...
function mapMacOSToEnhancedElements(nativeElements, parentPath = "") {
  ...
  function flatten2(elements, path2, depth, insideScrollBar = false) {
    const roleCounts = {};
    for (const el of elements) {
      ...
      if (isScrollBar) {
        if (el.children.length > 0) {
          flatten2(el.children, path2, depth + 1, true);
        }
        continue;
      }
...
var execFileAsync4, execAsync;
var init_macos = __esm({
  "src/native/macos.ts"() {
    init_extract3();
    init_role_map();
    execFileAsync4 = util.promisify(child_process.execFile);
...
async function getSession(outputDir, sessionId) {
  ...
  try {
    ...
    return exports.SessionSchema.parse(data);
  } catch {
    return null;
  }
}
...
async function findSessions(outputDir, query = {}) {
  const validatedQuery = exports.SessionQuerySchema.parse({
    limit: 50,
    ...query
  });
...
async function searchFlow(page, options) {
  ...
  try {
    ...
    const { combinedTextOrCssQuery: combinedTextOrCssQuery2 } = await Promise.resolve().then(() => (init_types(), types_exports));
...
var artifactReceiptSchema = zod.z.object({
  ...
  bytes: zod.z.number().int().nonnegative().max(MAX_EXTERNAL_ACTION_ARTIFACT_BYTES).optional(),
  path: boundedText.optional(),
  pathDisposition: zod.z.enum(["not-supplied", "transformed", "retained"])
}).strict();
...
async function testResponsive(url, options = {}) {
  ...
  for (const viewportSpec of viewports) {
    ...
    if (typeof viewportSpec === "string") {
      viewport = exports.VIEWPORTS[viewportSpec];
...
var DesignCheckOperatorSchema = zod.z.enum([
  "eq",
  // exact equality
  "gt",
...
var DesignCheckSchema = zod.z.object({
  property: zod.z.string(),
  operator: DesignCheckOperatorSchema,
  value: zod.z.union([zod.z.string(), zod.z.number()]),
  confidence: zod.z.number().min(0).max(1)
});
var DesignChangeSchema = zod.z.object({
  description: zod.z.string(),
  element: zod.z.string(),
  checks: zod.z.array(DesignCheckSchema),
  source: zod.z.enum(["structured", "parsed"]),
  platform: zod.z.enum(["web", "ios", "macos"]).optional(),
  timestamp: zod.z.string()
});
var DecisionEntryWithChecksSchema = DecisionEntrySchema.extend({
  checks: zod.z.array(DesignCheckSchema).optional()
});
...
// src/index.ts
init_scan();
var finite = zod.z.number().finite();
var NumberRuleSchema = zod.z.discriminatedUnion("mode", [
  zod.z.object({ mode: zod.z.literal("exact"), value: finite, tolerance: finite.nonnegative().default(0) }),
  zod.z.object({ mode: zod.z.literal("bounded"), min: finite, max: finite }).refine((v) => v.min <= v.max, "min must be <= max"),
  zod.z.object({ mode: zod.z.literal("free"), guidance: zod.z.string().optional() })
]);
var TextRuleSchema = zod.z.discriminatedUnion("mode", [
  zod.z.object({ mode: zod.z.literal("exact"), value: zod.z.string() }),
  zod.z.object({ mode: zod.z.literal("bounded"), oneOf: zod.z.array(zod.z.string()).min(1) }),
  zod.z.object({ mode: zod.z.literal("free"), guidance: zod.z.string().optional() })
]);
var StyleRulesSchema = zod.z.object({
...
var DesignElementSchema = zod.z.object({
  ...
  sourceNode: zod.z.object({
    id: zod.z.string(),
    name: zod.z.string(),
    type: zod.z.string(),
    fillTypes: zod.z.array(zod.z.string()).optional(),
    imageRefs: zod.z.array(zod.z.string()).optional(),
    prototypeDestinationId: zod.z.string().optional()
  }).strict().optional(),
...
var DesignSpecSchema = zod.z.object({
  version: zod.z.literal(1),
  ...
  source: zod.z.object({
    ...
    coverage: zod.z.object({
      ...
      skipped: zod.z.array(zod.z.object({ id: zod.z.string(), reason: zod.z.string() }).strict())
    }).strict().optional()
  }).strict(),
  /** Shared rules apply to every element of a role. Element rules override them. */
  sharedStyle: zod.z.object({ heading: StyleRulesSchema.optional() }).strict().optional(),
  views: zod.z.array(zod.z.object({
    id: zod.z.string().min(1),
    route: zod.z.string().startsWith("/"),
    viewport: zod.z.object({ width: finite.positive(), height: finite.positive() }).strict(),
    /** listed checks named elements; all-scanned also rejects unlisted semantic elements. */
    coverage: zod.z.enum(["listed", "all-scanned"]).default("listed"),
    ...
    freeRegions: zod.z.array(zod.z.object({
      name: zod.z.string().min(1),
      bounds: zod.z.object({ x: finite, y: finite, width: finite.positive(), height: finite.positive() }).strict().optional()
    }).strict()).default([])
  }).strict()).min(1)
...
var exactNumber = (value) => ({ mode: "exact", value, tolerance: 0 });
var exactText = (value) => ({ mode: "exact", value });
...
function designSpecFromFigmaFile(input, frameId, route, ref, routeMap = {}) {
  for (const [destination, path2] of Object.entries(routeMap)) {
    if (typeof path2 !== "string" || !path2.startsWith("/")) throw new Error(`Invalid application route for Figma node ${destination}`);
  }
...
function generateFixGuide(scanResult, bridgeResult, annotatedScreenshot) {
  ...
  const seen = /* @__PURE__ */ new Set();
  function dedupKey2(label, issueType) {
  ...
  for (const issue of scanResult.nativeIssues) {
    ...
    const key = dedupKey2(elementLabel2 || elementSelector, issue.type);
  ...
  for (const issue of scanResult.issues) {
    ...
    const key = dedupKey2(elementLabel2 || elementSelector, issueType);
    if (seen.has(key)) continue;
    seen.add(key);
...
init_extract3();
init_role_map();
var execFileAsync7 = util.promisify(child_process.execFile);
...
var deliverKeystrokeOneShot = async (pid, chord, foreground) => {
  const extractorPath = await ensureExtractor();
...
init_macos();
var execFileAsync9 = util.promisify(child_process.execFile);
var LAUNCH_TIMEOUT_MS = 8e3;
var QUIT_TIMEOUT_MS = 6e3;
var POLL_MS = 250;
...
// src/native/menu.ts
init_extract3();
var execFileAsync10 = util.promisify(child_process.execFile);
var SETTLE_MS2 = 250;
async function resolveMenuTargetPid(target) {
  if (target.kind === "macos") return target.pid;
  return findProcess("com.apple.iphonesimulator");
}
var deliverMenuOneShot = async (pid, menuPath) => {
  const extractorPath = await ensureExtractor();
...
var execFileAsync11 = util.promisify(child_process.execFile);
...
async function macOSNativePreflight(options) {
  if (!isMacOS()) {
    return {
      ok: false,
      reason: "not-macos",
      message: `Native sessions require macOS \u2014 process.platform is '${process.platform}'. Use a Mac to run macOS / iOS-simulator AX sessions.`
    };
  }
  ...
  const extractorPath = path.join(process.cwd(), ".ibr", "bin", "ibr-ax-extract");
  const swiftSourceDir = path.join(process.cwd(), "src", "native", "swift", "ibr-ax-extract");
  if (!fs$1.existsSync(extractorPath) && !fs$1.existsSync(path.join(swiftSourceDir, "Package.swift"))) {
    return {
      ok: false,
...
async function simulatorNativePreflight(options) {
  const base = await macOSNativePreflight();
...
var NativeSessionController = class {
  store;
  injectedBackend;
  constructor(opts) {
...
var nativeSessionController = new NativeSessionController();
...
var SEP = "\0";
var ResolvedPathCache = class _ResolvedPathCache {
...
var resolvedPathCache = new ResolvedPathCache();
...
var InterfaceBuiltRight = class {
  config;
  constructor(options = {}) {
    this.config = exports.ConfigSchema.parse(options);
  }
  /**
  ...
  async start(url, options = {}) {
    ...
    const viewport = exports.VIEWPORTS[viewportName];
    const driver2 = new EngineDriver();
    await driver2.launch({
...
exports.DEFAULT_REGIONS = DEFAULT_REGIONS;
exports.DEFAULT_RETENTION = DEFAULT_RETENTION;
exports.DaemonBackend = DaemonBackend;
exports.DaemonError = DaemonError;
exports.DecisionEntrySchema = DecisionEntrySchema;
exports.DecisionEntryWithChecksSchema = DecisionEntryWithChecksSchema;
...
exports.DesignElementSchema = DesignElementSchema;
exports.DesignSpecSchema = DesignSpecSchema;
...
exports.NumberRuleSchema = NumberRuleSchema;
exports.ResolvedPathCache = ResolvedPathCache;
exports.RespawnBackend = RespawnBackend;
exports.SIMULATOR_DRIVER_ENV = SIMULATOR_DRIVER_ENV;
exports.TextRuleSchema = TextRuleSchema;
exports.VERDICT_POLICY_KEYS = VERDICT_POLICY_KEYS;
exports.WEB_VERDICT_POLICY = WEB_VERDICT_POLICY;
exports.__setNativeBackend = __setNativeBackend;
...
exports.checkDesignSpec = checkDesignSpec;
...
exports.designSpecFromFigmaFile = designSpecFromFigmaFile;
...
exports.deviceToViewport = deviceToViewport;
...
exports.ensureExtractor = ensureExtractor;
exports.extractApiCalls = extractApiCalls;
exports.extractMacOSElements = extractMacOSElements;
exports.extractNativeElements = extractNativeElements;
...
exports.formatNativeCandidate = formatNativeCandidate;
exports.formatNativeScanResult = formatNativeScanResult;
...
exports.getBootedDevices = getBootedDevices;
...
exports.isDiffMarker = isDiffMarker;
...
exports.mapMacOSToEnhancedElements = mapMacOSToEnhancedElements;
exports.mapSessionActionToNative = mapSessionActionToNative;
exports.mapToEnhancedElements = mapToEnhancedElements;
...
exports.viewportToConfig = viewportToConfig;
