...
function ImagePane({
  ...
  return (
    <div className="flex flex-1 flex-col overflow-auto p-4">
      <span className="mb-2 text-[11px] font-medium text-[var(--text-muted)] uppercase tracking-wide">
        {label}
      </span>
      <div className="relative">
        ...
        {error ? (
          <div className="flex h-64 flex-col items-center justify-center rounded-xl border border-dashed border-[rgba(255,255,255,0.06)]">
            ...
            <span className="text-[13px] text-[var(--text-muted)]">{label} not available</span>
