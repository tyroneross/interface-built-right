...
**Calm Precision Rules** — Which Calm Precision principles apply (see the vendored `calm-precision` skill) to this component and how. Specific, measurable — "do not add a border to each list item, use a divider instead."
