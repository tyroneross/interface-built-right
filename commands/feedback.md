---
name: feedback
description: Report a bug or send feedback about the ibr plugin
---

# Report ibr feedback

File the user's report as a GitHub issue on `tyroneross/interface-built-right`. Issues are this plugin's
...
```bash
gh issue create --repo tyroneross/interface-built-right \
...
5. If `gh` is missing or unauthenticated, do not fail — print the URL so the user
   can open it in a browser: https://github.com/tyroneross/interface-built-right/issues/new
